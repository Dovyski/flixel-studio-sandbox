...
/**
 * This state is focused on testing tilemaps.
 */
class PlayStateTiles extends FlxState
{
	...
	var _tileMapMedium:FlxTilemap;
	var _tileMapLarge:FlxTilemap;
	...
	function generateLevel():Void
	{
		...
		_tileMapMedium = new FlxTilemap();
		_tileMapMedium.loadMapFromArray(map, MAP_WIDTH_IN_TILES, MAP_HEIGHT_IN_TILES, AssetPaths.img_tiles_medium__png, 16, 16);
		add(_tileMapMedium);

		_tileMapLarge = new FlxTilemap();
		_tileMapLarge.loadMapFromArray(map, MAP_WIDTH_IN_TILES, MAP_HEIGHT_IN_TILES, AssetPaths.img_tiles_large__png, 32, 32);
		add(_tileMapLarge);
	}
